...
exports.getCurrentWeather = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, location = _a.location, language = _a.language;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, axios_1.default.get(BASE_URL + "?q=" + encodeURI(location) + "&units=metric&lang=" + language + "&appid=" + API_KEY)];
            case 2:
                response = _b.sent();
                if (response.data) {
