...
var getLocation = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, lat, long, query, response, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, lat = _a.lat, long = _a.long;
                query = encodeURI(lat + "," + long);
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, axios_1.default.get(BASE_URL + "/json?q=" + query + "&key=" + API_KEY)];
            case 2:
                response = _b.sent();
